...
//                let url = URL(fileURLWithPath: pdfurl)
    ...
    static func fileUploadAPIDocumentMultipleImage(inputUrl:String,parameters:[String:Any],imageName: [String],imageFile : [UIImage],completion:((AnyObject?,Bool,AnyObject?) -> Void)?){
        
        print(parameters,imageName)
